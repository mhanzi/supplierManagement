...
//			$this->items_per_page = $this->default_ipp;
		...
		if ($this->num_pages > 10){
			$this->return = ($this->current_page > 1 And $this->items_total >= 10) ?
				"<a class=\"paginate\" href=\"$_SERVER[PHP_SELF]?page=$prev_page&ipp=$this->items_per_page$this->querystring\">&laquo; Previous</a> " :
				"<a class=\"paginate\" href=\"#\">&laquo; Previous</a> ";
			...
			for ($i = 1; $i <= $this->num_pages; $i++) {
				if ($this->range[0] > 2 And $i == $this->range[0]){
					$this->return .= " <a href='#'>...</a> ";
				}
				// loop through all pages. if first, last, or in range, display
				if ($i == 1 Or $i == $this->num_pages Or in_array($i, $this->range)){
					$this->return .= ($i == $this->current_page And $_GET['page'] != 'All') ?
						"<a title=\"Go to page $i of $this->num_pages\" class=\"selected\" href=\"#\">$i</a> " :
			...
			$this->return .= (($this->current_page < $this->num_pages And $this->items_total >= 10) And
				($_GET['page'] != 'All') And $this->current_page > 0) ?
			...
			$this->return .= ($_GET['page'] == 'All') ?
				"<a class=\"selected\" style=\"margin-left:10px\" href=\"#\">All</a> \n" :
				"<a class=\"paginate\" style=\"margin-left:10px\" href=\"$_SERVER[PHP_SELF]?page=1&ipp=All$this->querystring\">All</a> \n";
		}
		else {
			for ($i = 1; $i <= $this->num_pages; $i++) {
				$this->return .= ($i == $this->current_page) ? "<a class=\"selected\" href=\"#\">$i</a> " :
		...
		$this->limit = (isset($_GET['ipp']) and $_GET['ipp'] == 'All') ? "" : " LIMIT $this->low,$this->items_per_page";
	}

            ...
            <table class="table table-bordered">
				...
				<?php foreach($seats as $seat) { ?>
                    <tr>
						...
						<p> <?php echo $seat['article'] ;?>
                            </p>
                            <br>
                            <button id="btn35_20" type="button" class="btn">Dettagli articolo</button>
                        </td>
                        <td>
						...
						<?php $get_img = $this->db_model->get_images($seat['img_seat']);
                            ...
                            <img src="<?php echo  base_url()."/uploads/seats/".$get_img[0]['file_name']; ?>" class="img-responsive img-rounded" alt="Tavolo" style="width:auto;height:auto;">
							<?php } ?>
                        </td>
                    </tr>
					<?php } ?>
